...
`,document.querySelector("#header h1").innerHTML=`
    ...
    `,r.querySelector("#workBtn").addEventListener("click",()=>s(document.querySelector("#MyAPPP"))),r.querySelector("#contactBtn").addEventListener("click",()=>c(document.querySelector("#MyAPPP"))),r.querySelector("#iconMe").addEventListener("click",()=>o(document.querySelector("#header")))}o(document.querySelector("#header"));
